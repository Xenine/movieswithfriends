    ...
    return (
      <div className="wrapper clear">
        <header className="d-flex justify-between p-25">
          <div className="d-flex align-center ml-10">
            <img width={42} hight={34} src="/img/logo.svg" alt="logo"/>
            <div className="ml-10">
          ...
          <ul className="headerRight d-flex align-center">
            <li><span>О сайте</span></li>
            <li><span>Поиск</span></li>
            <li><span>Войти</span></li>
            <li><img width={54} hight={54} src="/img/account.svg" alt="account"/></li>
          </ul>
            ...
            <div className="card d-flex">
              <div className="cardLeft">
                <ul className="d-flex align-center ml-10 mt-10">
                  <li className="mr-10">
                    <img className="cardAvatar" width={80} hight={80} src="/img/avatar1.jpg" alt="ava"/>
                  </li>
                  <li>
